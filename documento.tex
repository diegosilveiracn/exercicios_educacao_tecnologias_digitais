...
\begin{enumerate}
		\item Acesse o ChatGPT e faça a pergunta ``Como surgiu a internet?´´
		\item Selecione uma letra de música em inglês na internet e traduza para o português via DeepL.
		\item Usando o assistente virtual do seu celular, solicite que ele o lembre de beber água após 5 minutos.
\end{enumerate}
